...
export class HTTPClient {
  ...
  static post<TResponseData>(
    path: string,
    options: TRequestOptions = {},
    signal?: AbortSignal,
  ) {
    return HTTPClient.request<TResponseData>(
      `${HTTPClient.BASE_URL}${path}`,
      {
        ...options,
